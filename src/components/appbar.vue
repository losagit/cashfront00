<template>
  <v-card >
    <v-app-bar dense app elevate-on-scroll  class="mx-1 mt-1" dark color="teal" >
          ...
          <span style="cursor: pointer" v-bind="attrs" v-on="on">
            <v-chip link>
              <v-badge dot bottom color="green" offset-y="10" offset-x="10">
                <v-avatar size="40">
                  <v-img src="https://png.pngtree.com/png-clipart/20190516/original/pngtree-users-vector-icon-png-image_3725294.jpg" />
                </v-avatar>
              </v-badge>
